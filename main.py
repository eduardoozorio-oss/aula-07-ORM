...
#criar um objeto
produto1 = Produto("Notebook positivo nada negativo ", 5000, 10, True)
...
#busca parcial
produtos_note = session.query(Produto).filter(Produto.nome.like("%book")).all()
for p in produtos_note:
    print(p)